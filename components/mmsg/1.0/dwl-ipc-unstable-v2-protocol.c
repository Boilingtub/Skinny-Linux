...
static const struct wl_message zdwl_ipc_manager_v2_requests[] = {
	...
	{ "get_output", "no", dwl_ipc_unstable_v2_types + 6 },
};
...
static const struct wl_message zdwl_ipc_output_v2_requests[] = {
	...
	{ "quit", "2", dwl_ipc_unstable_v2_types + 0 },
	{ "dispatch", "2ssssss", dwl_ipc_unstable_v2_types + 0 },
};
...
static const struct wl_message zdwl_ipc_output_v2_events[] = {
	...
	{ "x", "2i", dwl_ipc_unstable_v2_types + 0 },
	{ "y", "2i", dwl_ipc_unstable_v2_types + 0 },
	{ "width", "2i", dwl_ipc_unstable_v2_types + 0 },
	{ "height", "2i", dwl_ipc_unstable_v2_types + 0 },
	{ "last_layer", "2s", dwl_ipc_unstable_v2_types + 0 },
	{ "kb_layout", "2s", dwl_ipc_unstable_v2_types + 0 },
};

WL_PRIVATE const struct wl_interface zdwl_ipc_output_v2_interface = {
	"zdwl_ipc_output_v2", 2,
	6, zdwl_ipc_output_v2_requests,
	16, zdwl_ipc_output_v2_events,
};
