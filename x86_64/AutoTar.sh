...
tar czvf ./Compressed-Archives/dwl-v0.7-jan.tar.gz ./dwl-v0.7-jan
tar czvf ./Compressed-Archives/foot.tar.gz ./foot
tar czvf ./Compressed-Archives/bright.tar.gz ./bright
tar czvf ./Compressed-Archives/slstatus.tar.gz ./slstatus
tar czvf ./Compressed-Archives/wbg.tar.gz ./wbg
#tar czvf ./Compressed-Archives/kickoff.tar.gz ./kickoff
tar czvf ./Compressed-Archives/neovim.tar.gz ./neovim
